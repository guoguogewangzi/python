...
PASSWORD_DIC =  ['redis', 'root', 'oracle', 'password', 'p@aaw0rd', 'abc123!', '123456', 'admin', '12345678', '666666','88888888', '1234567890', '888888','mypassword']
            ...
            if "redis_version" in result.decode():
                ...
                for pass_ in PASSWORD_DIC:
                    ...
                    if '+OK' in result.decode():
                        time.sleep(random.random())
                        vule_date = {'vule_name': 'redis week_password', 'severity': 'high', 'vule_url': ip + ':' + port+'  week_password: '+pass_,'url': date}
                        print(vule_date)
                        return vule_date
